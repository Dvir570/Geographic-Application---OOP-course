...
public class ResultFile {
	...
	public static ArrayList<Row> result = new ArrayList<Row>();
	private IOfiles writeResultFile;
	...
	public void writeDB() {
		for (int i = 0; i < result.size(); i++) {
			...
			str += (wifi.getSSID() + "," + wifi.getMac() + "," + wifi.getFreq() + "," + wifi.getSignal()); // print //
																											// the
			// end
			writeResultFile.writeLine(str, fileExist.exists());
		}
	}
	 ...
	 */
	public void rowsGroupByTimeModel(ArrayList<WiFi> wifis) {
