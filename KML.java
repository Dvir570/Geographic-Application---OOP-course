	...
	public void makeKML(ArrayList<WiFi> toDisplay) {
		...
		for (int i = 0; i < toDisplay.size(); i++) {
			...
			doc.createAndAddPlacemark().withName(w.getSSID()).withOpen(Boolean.TRUE)
					.withDescription("mac: " + w.getMac() + " freq: " + w.getFreq() + " signal: " + w.getSignal())//.withTimePrimitive(timePrimitive)
		...
		try {
			kml.marshal(new File(
					"C:\\Users\\dvir\\Documents\\Ariel University\\Eclipse Workspace\\Matala0\\src\\KML Files\\placemarkes.kml"));
